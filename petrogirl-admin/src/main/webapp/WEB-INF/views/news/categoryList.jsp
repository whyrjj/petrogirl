	...
	<div class="am-cf admin-main">
		...
		<div class="admin-content">
			<div class="am-cf am-padding">
		      <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">新闻</strong> / <small>产品类型列表</small>
			  </div>
		    </div>
		    
		    
			<form:form action="${ctx }${adminPath }/news/category/list${urlSuffix}" method="post" modelAttribute="form" class="am-form-inline">
						...
						<table class="am-table am-table-striped am-table-hover table-main">
							...
							<tbody>
								<c:forEach items="${form.pageView.records }" var="category">
									<tr>
										<td style="color:yellow"><a href="${ctx }${adminPath }/news/list${urlSuffix}?queryBean.category.id=${category.id }">${category.title }</a></td>
										<td>${category.lang }</td>
										...
										<td>
											...
											<a type="button" href="${ctx }${adminPath }/news/add${urlSuffix}?category.id=${category.id }"  class="am-btn am-btn-primary am-btn-sm">
											 ...
											 　　
											<a type="button" href="${ctx }${adminPath }/news/category/del${urlSuffix}?id=${category.id }" class="am-btn am-btn-primary am-btn-sm">
												删除
											</a>
										</td>
									</tr>
