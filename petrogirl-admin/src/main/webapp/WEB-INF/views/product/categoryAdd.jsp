	...
	<div class="am-cf admin-main">
		...
		<div class="admin-content">
			...
			<div class="am-cf am-padding">
		      <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">产品</strong> / <small>类型添加</small>
				</div>
		    </div>
			
		    <div class="am-g">
		      <div class="am-u-sm-12">
		      	<form:form action="${ctx }${adminPath }/product/category/add${urlSuffix}" method="post" modelAttribute="category" cssClass="am-form">
					...
					<table class="am-table am-table-striped table-main am-text-nowrap">
						...
						<tr>
							<td colspan="2">
								<img id="newImg" src="${ctxStatic }/assets/images/product_bg.png" class="am-img-responsive am-img-thumbnail" style="max-height: 400px;max-width: 400px;"/>
							</td>
						</tr>
