	...
	<div class="am-cf admin-main">
		...
		<div class="admin-content">
			<div class="am-cf am-padding">
		      <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">产品</strong> / <small>产品列表</small>
			  </div>
		    </div>
		    
		    
			<form:form action="${ctx }${adminPath }/product/list${urlSuffix}" method="post" modelAttribute="form" class="am-form-inline">
			...
			<div class="am-cf am-padding"> 类型：
				...
				<a href="${ctx }${adminPath }/product/add${urlSuffix}?category.id=${category.id }" class="am-btn am-btn-success">添加产品</a>
			</div>
						...
						<tbody>
							<c:forEach items="${form.pageView.records }" var="note">
								<tr>
									...
									<td>
										<a type="button" href="${ctx }${adminPath }/product/del${urlSuffix}?id=${note.id }" class="am-btn am-btn-primary am-btn-sm">
											删除
										</a>
									</td>
								</tr>
