...
(function($) {
  ...
  AmazeuiUpload.prototype._defaultComplete = function(file) {
    ...
    if (result != null && result != undefined && result.status) {
      this._defaultCompleteStatus(file, result.status);
    } else {
  ...
  AmazeuiUpload.prototype._defaultCompleteStatus = function(file, status) {
